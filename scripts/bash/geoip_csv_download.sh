...
do 
  # download zip files :
  curl -s -o ${file}.zip https://download.maxmind.com/app/geoip_download?edition_id=${file}\&license_key=si66vuh7Wp6w\&suffix=zip
  # download md5 files :
  curl -s -o ${file}.md5 https://download.maxmind.com/app/geoip_download?edition_id=${file}\&license_key=si66vuh7Wp6w\&suffix=zip.md5
